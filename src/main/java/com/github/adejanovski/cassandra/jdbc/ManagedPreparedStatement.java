...
class ManagedPreparedStatement extends AbstractStatement implements PreparedStatement {
    ...
    ManagedPreparedStatement(PooledCassandraConnection pooledCassandraConnection,
            ManagedConnection managedConnection, CassandraPreparedStatement preparedStatement) {
